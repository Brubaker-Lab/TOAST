---
title: "GSEA for ACLR and DMM Hallmark"
author: "Brendan Ball"
date: "2024-04-30"
...
```{r ACLR MOUSE GENE SET ENRICHMENT ANALYSIS - hallmark PATHWAY}
...
# Save for hallmark pathway
hallmark_gsea_ACLR_list <- gsea_results_list
# Save the GSEA File 
#write.xlsx(hallmark_gsea_ACLR_list, "GSEA_hallmark_ACLR.xlsx")
```

```{r DMM MOUSE GENE SET ENRICHMENT ANALYSIS - hallmark PATHWAY}
# SET THE DESIRED ORGANISM HERE
organism <- "org.Hs.eg.db"
# Prepare the dataset to be used for GSEA (hallmark)
hs_hallmark_sets <- msigdbr(species = "Homo sapiens",
...
# Save for hallmark pathway
hallmark_gsea_DMM_list <- gsea_results_list
# Save the GSEA File 
#write.xlsx(hallmark_gsea_DMM_list, "GSEA_hallmark_DMM.xlsx")
```
